package com.tb.hc.advice;

import com.tb.hc.common.enums.ResCodeEnum;
import com.tb.hc.common.exception.GlobalException;
import com.tb.hc.common.exception.ServiceException;
import com.tb.hc.common.response.BaseResponse;
...
//    }
  ...
  public BaseResponse exception(Exception ex) {
    return resultFormat(ResCodeEnum.RESCODE_BAD_REQUEST, ex);
  }
