package com.tb.hc.common.response;
...
public class BaseResponse<T> implements Serializable {
  ...
  public BaseResponse(Integer resCode, String resMsg, String traceID, String spanID,
  ...
  public BaseResponse(Integer resCode, String resMsg) {
    this(resCode, resMsg, null);
  }

  public BaseResponse(Integer resCode) {
    this(resCode, ResCodeEnum.getResCodeEnum(resCode));
  }

  public BaseResponse(Integer resCode, T resData) {
    this(resCode, ResCodeEnum.getResCodeEnum(resCode), resData);
  }

  public BaseResponse(Integer resCode, String resMsg, T resData) {
